...
@section('title', (isset($case) ? 'Editar Caso - ' : 'Nuevo Caso - ') . tenantSetting('name', 'Tenant'))
...
<div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 border-bottom pb-3">
        <h3 class="fw-bold mb-0" style="color: {{ tenantSetting('text_color_1', '#8C2D18') }};">
            <i class="bi bi-pencil-square me-2"></i>{{ isset($case) ? 'Editar Caso' : 'Nuevo Caso' }}
        </h3>
    ...
    <div class="card shadow border-0" style="background-color: {{ tenantSetting('background_color_1', '#FDF5E5') }};">
        <div class="card-body p-4">
            <form method="POST"
                action="{{ isset($case) ? route('cases.update', $case->id) : route('cases.store') }}">
                @csrf
                @if(isset($case)) @method('PUT') @endif

                {{-- Título --}}
                <div class="mb-4">
                    <label for="title" class="form-label fw-medium" style="color: {{ tenantSetting('text_color_1', '#8C2D18') }};">
                ...
                {{-- Descripción --}}
                <div class="mb-4">
                    <label for="description" class="form-label fw-medium" style="color: {{ tenantSetting('text_color_1', '#8C2D18') }};">
                    ...
                    <div class="input-group">
                        ...
                        <textarea id="description" name="description" class="form-control border-start-0"
                            rows="4"
                            style="background-color: {{ tenantSetting('background_color_1', '#FDF5E5') }};"
                ...
                {{-- Estado --}}
                <div class="mb-4">
                    <label for="status" class="form-label fw-medium" style="color: {{ tenantSetting('text_color_1', '#8C2D18') }};">
                ...
                {{-- Usuario asignado --}}
                <div class="mb-4">
                    <label for="user_id" class="form-label fw-medium" style="color: {{ tenantSetting('text_color_1', '#8C2D18') }};">
                ...
                <div class="mt-4 pt-3 border-top text-center">
                    <button type="submit" class="btn fw-medium py-1"
                        style="background-color: {{ tenantSetting('navbar_color_2', '#8C2D18') }};
                               ...
                               width: 200px;">
                        <i class="bi bi-save me-2"></i>{{ isset($case) ? 'Actualizar Caso' : 'Crear Caso' }}
                    </button>
                </div>
            </form>
        </div>
